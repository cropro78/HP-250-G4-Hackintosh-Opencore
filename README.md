...
I will upload my EFI Opencore folder (Hope it helps for building your own Opencore EFI folder, please don't use it as it is, since this probably isn't the most compatible version for your laptop, and you won't learn anything if you go this path), but without the ACPI patches, since for best compatibility you will have to compile those patches by yourself. And for kexts, please just use it from sources to get the latest version of the same.
